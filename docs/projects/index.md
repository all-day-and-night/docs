...
| # | 프로젝트 | 기간 | 역할 | 핵심 기술 |
|---|---------|------|------|----------|
| 01 | [차세대 사회보장 행복e음](./01-happy-eeum) | 2022.10~2023.02 | BE | Spring Batch, Oracle |
| 02 | [LG CNS MOP (AWS EKS)](./02-mop-eks) | 2023.07~2024.02 | Cloud Engineer | Terraform, EKS, SageMaker |
| 03 | [LGE 모니터 신청](./03-lge-monitor) | 2024.03~2024.05 | Fullstack | Spring Boot, React, MySQL |
| 04 | [미래엔 AI 교과서](./04-mirae-n) | 2024.05~2024.10 | FE | React, TypeScript |
| 05 | [LGD 뉴스 기업 분석](./05-lgd-news-analysis) | 2024.11~2024.12 | BE | Python, FastAPI, Docker |
| 06 | [LGE 메뉴얼 생성](./06-lge-manual) | 2024.11~2024.12 | BE | Python, FastAPI, python-pptx |
| 07 | [LGD 메일 AI Agent](./07-lgd-mail-agent) | 2025.01~2025.06 | BE / Architect | Java, Spring, Llama, Exaone |
| 08 | [DnO AI Agent](./08-dno-agent) | 2025.06~2025.07 | BE | Bedrock, OpenSearch, RAG |
| 09 | [신한카드 여행 앱](./09-shinhan-travel) | 2025.09~2025.10 | BE | Strands Agents, Knowledge Base |
| 10 | [KDB 생명 Agentic AI](./10-kdb-life) | 2025.10~2025.11 | BE | AWS Bedrock, FastAPI |
...
| 13 | [NH농협손해보험 Frontend Vue 전환](./13-nhfire-frontend) | 2026.04~ | FE | Vue 3, Vite, Capacitor, Claude Harness |
| 14 | [AWS EKS LLM 인프라 실습](./14-eks-llm-infra) | 2026.06~ | 개인 실습 | EKS, vLLM, Terraform |
